...
function LoginRegistr() {
  ...
  const error = useSelector((state) => state.loginRegistrReducer.error);
      ...
      <Card sx={{ width: "400px" }}>
        <CardContent>
          ...
          >
            ...
            <TextField
              value={password}
              error={!haveAccount && password !== repeatPassword || password.length < 6}
        ...
        >
          <Button
             disabled={!haveAccount && password !== repeatPassword || password.length < 6}
